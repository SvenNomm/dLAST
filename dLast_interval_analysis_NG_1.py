...
from update_goodness_measures import update_goodness_measures
from compute_ranges import compute_ranges
...
for test_nr in range(0, 6):
    ...
    if test_nr != 1 and test_nr != 4:
        ...
        for interval_type in range(0,2):
            ...
            if interval_type == 1:
                goodness_measures = update_goodness_measures(goodness_measures, goodness_measures_s,  test_nr, list_of_classifiers)

            print("---Ranges for the test ", test_names[test_nr], "  interval type", interval_type, "---------------")

            pandas_ranges = compute_ranges(goodness_measures, list_of_classifiers, test_nr, goodness_measures_list)
            print("-------------------------------------------------------------------------------------------------")
            ...
            if interval_type == 0:
                goodness_measures_s = goodness_measures
